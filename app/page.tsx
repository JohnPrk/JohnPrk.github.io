    ...
    <div className="flex flex-col gap-10">
      ...
      <section className="relative overflow-hidden rounded-2xl border border-white/10 bg-black/45 shadow-2xl backdrop-blur-xl">
        <div className="p-7 text-center md:p-10">
          ...
          <div className="mx-auto mt-5 max-w-2xl space-y-4 text-[14px] leading-[1.95] text-ink-soft">
            <p>
          ...
          <div className="mx-auto mt-6 flex w-max flex-wrap items-center justify-center gap-x-4 gap-y-2 rounded-full border border-white/10 bg-white/5 px-4 py-2 font-mono text-[12.5px] text-ink-muted">
